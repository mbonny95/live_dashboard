...
- **copyToClipboard()** (1 connections) — `public/prefs.js`
- **exportText()** (1 connections) — `public/prefs.js`

## Relationships

- [Support Micro-Framework Runtime](Support_Micro-Framework_Runtime.md) (2 shared connections)
