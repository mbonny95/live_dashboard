...
- **discovery.js** (19 connections) — `public/discovery.js`
- **discoverRooms()** (7 connections) — `public/discovery.js`
- **domainOf()** (7 connections) — `public/discovery.js`
- **isExcluded()** (5 connections) — `public/discovery.js`
...
- **discoverAlarm()** (1 connections) — `public/discovery.js`
- **discoverModes()** (1 connections) — `public/discovery.js`
- **mapEnergyPrefs()** (1 connections) — `public/discovery.js`
- **resolveEntityArea()** (1 connections) — `public/discovery.js`

## Relationships

- [support.js Micro-Framework Runtime](support.js_Micro-Framework_Runtime.md) (1 shared connections)
