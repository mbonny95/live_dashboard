...
- **ref Callback for src/href/points Binding** (4 connections) — `public/dash_neumo.html`
...
- **Header Bar** (3 connections) — `public/dash_neumo.html`
- **Irrigation Zone Card** (3 connections) — `public/dash_neumo.html`
- **Rooms Grid** (3 connections) — `public/dash_neumo.html`
- **Vehicle (Auto) Tab** (3 connections) — `public/dash_neumo.html`
- **Surveillance Tab** (3 connections) — `public/dash_neumo.html`
- **Energy Tab** (3 connections) — `public/dash_neumo.html`
- **Irrigation Tab** (3 connections) — `public/dash_neumo.html`
...
- **Settings Rooms Hide/Reorder List** (2 connections) — `public/dash_neumo.html`
