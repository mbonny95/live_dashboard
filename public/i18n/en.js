window.CasaStrings = window.CasaStrings || {}; window.CasaStrings.en = {
  ...
  settingsSectionOrder: 'Home section order', settingsSectionOrderReset: 'Reset to default order',
  settingsSectionOrderResetTitle: 'Reset to the default order?',
  settingsSectionOrderResetBody: 'Alarm, energy, and cameras will go back to their starting order.',
  ...
  diagHourlyInUse: 'Hourly strip', diagHourlyNoEnergy: 'none (energy not configured)',
  diagHourlyLoading: 'loading…', diagHourlyMissing: 'no hourly statistics found',
  diagHourlyFull: '24 hours available',
  ...
  'energy.hourlyPeak': 'Peak at {time}',
  ...
  'diag.hourlyPartial': '{n}/24 hours available (partial)',
