window.CasaStrings = window.CasaStrings || {}; window.CasaStrings.it = {
  ...
  settingsSectionOrder: 'Ordine sezioni Casa', settingsSectionOrderReset: 'Ripristina ordine predefinito',
  settingsSectionOrderResetTitle: 'Ripristinare l’ordine predefinito?',
  settingsSectionOrderResetBody: 'Allarme, energia e telecamere torneranno all’ordine di partenza.',
  ...
  diagHourlyInUse: 'Striscia oraria', diagHourlyNoEnergy: 'nessuna (energia non configurata)',
  diagHourlyLoading: 'in caricamento…', diagHourlyMissing: 'nessuna statistica oraria trovata',
  diagHourlyFull: '24 ore disponibili',
  ...
  'energy.hourlyPeak': 'Picco alle {time}',
  ...
  'diag.hourlyPartial': '{n}/24 ore disponibili (parziale)',
